...
public class FiguresController {
    ...
    public
    @ResponseBody
    ResponseEntity<SumEntity> sum(@RequestParam(value = "first", defaultValue = "0") int first, @RequestParam(value = "second", defaultValue = "0") int second) {
    ...
    public
    @ResponseBody
    ResponseEntity<SubtractEntity> subtract(@RequestParam(value = "first", defaultValue = "0") int first, @RequestParam(value = "second", defaultValue = "0") int second) {
    ...
    public
    @ResponseBody
    ResponseEntity<MultiplyEntity> multiply(@RequestParam(value = "first", defaultValue = "0") int first, @RequestParam(value = "second", defaultValue = "0") int second) {
    ...
    public
    @ResponseBody
    ResponseEntity<Figures> allOperations(@RequestParam(value = "first", defaultValue = "0") int first, @RequestParam(value = "second", defaultValue = "0") int second) {
